...
getImageSettings :
    Cmd
        (Result
            ...
            ( List Generated.Data.ImageSettings.ImageSettings, Generated.Data.ImageSettings.PathSegment )
        )
getImageSettings =
    Http.request
        { method = "GET"
                    ...
                    case a of
                        ...
                        Http.GoodStatus_ b c ->
                            Result.mapError
                                ...
                                (Json.Decode.decodeString (Json.Decode.map2 Tuple.pair (Json.Decode.index 0 (Json.Decode.list Generated.Data.ImageSettings.decodeImageSettings)) (Json.Decode.index 1 Generated.Data.ImageSettings.decodePathSegment)) c)
                )
        , timeout = Nothing
        , tracker = Nothing
        }
